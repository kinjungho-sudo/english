...
export const STATIC_SCENARIOS: Scenario[] = [
  ...
  },
  {
    ...
    name: 'Café Order',
    location: 'A cozy café in Seattle',
    npc_name: 'LUCY',
    npc_personality: 'Cheerful barista who loves helping customers',
    thumbnail: '☕',
    order_index: 4,
  },
  {
    ...
    npc_name: 'JAMES',
    npc_personality: 'Friendly and chatty taxi driver',
    thumbnail: '🚕',
    order_index: 5,
  },
  {
    ...
    name: 'Shopping',
    location: 'A department store in New York',
    npc_name: 'KATE',
    npc_personality: 'Helpful and upbeat store clerk',
    thumbnail: '🛍️',
    order_index: 6,
  },
  {
    ...
    name: 'Pharmacy',
    location: 'A pharmacy in San Francisco',
    npc_name: 'CHEN',
    npc_personality: 'Knowledgeable and caring pharmacist',
    thumbnail: '💊',
    order_index: 7,
  },
]
